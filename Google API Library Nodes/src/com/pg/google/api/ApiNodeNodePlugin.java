 ...
 */
public class ApiNodeNodePlugin extends Plugin {
    // The shared instance.
    private static ApiNodeNodePlugin plugin;

    /**
     * The constructor.
     */
    public ApiNodeNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ApiNodeNodePlugin getDefault() {
        return plugin;
    }
